...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _signUpWithGoogle() async {
    ...
    try {
      const webClientId = '183050748282-5oakepmh0cvdc0riltmui6n6bcifhhac.apps.googleusercontent.com'; // Replace with your Google Web Client ID
      const iosClientId = ""; // Replace with your Google iOS Client ID
